        ...
        <main>
            ...
            <div className={styles.content1}>
                <div className={styles.text}>
                    <p>江本梨園は、千葉県の鎌ケ谷市、初富にあるおいしい梨園です。</p>
                    <p>鎌ヶ谷は梨の生産地として歴史が古く、江戸時代から栽培が始められました。
                        千葉県は梨の産出額、栽培面積において日本一ですが、鎌ヶ谷は平成18年以降県内3位産出額と栽培面積を誇ります。</p>
                    <p>江本梨園では毎年お客様においしいと言っていただける梨を少しでも多くご提供できるよう、日々梨の生産作業を続けております。</p>
                </div>
                <div className={styles.imgRight}>
                    <img src="works/c0bee5_e89bb84609174b12b51ac42721979a54.avif" alt="" />
                    <img src="works/c0bee5_098c33ffda1943a48197fa2271c921bf.avif" alt="" />
                </div>
            </div>
            ...
            <SeasonChart />
            <p className={styles.text2}>その年の天候や流行する梨の病気、害虫等で品質や生産量に影響が出ることもございます。</p>
        </main>
    )
}